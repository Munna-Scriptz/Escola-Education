        ...
        <section id='Popular' className='mt-[120px]'>
            <div className="container">
                <div id="Popular-Row">
                    ...
                    {/* --------------Courses Card------------------ */}
                    <div className='relative pt-[45px] flex items-center gap-[28px]'>
                        <div className='bg-[#FCCC44] px-[40px] py-[35px] rounded-[20px] w-fit'>
                            <p className='font-inter lg:text-[21px] text-base text-secondBK mt-[17px] font-bold'>Education Is The Key</p>
